...
def depth_trainer_func(hparams,train_dataset,valid_dataset=None):   
    ...
    checkpoint_callback = ModelCheckpoint(dirpath=ckpt_dir,
                                        #   filename='{epoch}-{loss_epoch:.4f}',
                                          ...
                                          every_n_epochs = 1,
                                          save_top_k=15, # -1: save for every epoch
                                          )
    ...
    if hparams.ckpt_path is not None:
        ...
        system = system.load_from_checkpoint(hparams.ckpt_path,**{'hparams':hparams},map_location='cpu',strict=hparams.strict)
    else:
