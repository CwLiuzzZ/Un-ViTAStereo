...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-path', default='Pic', type=str)
    ...
    parser.add_argument('--pred-only', type=bool, default=True)
    ...
    for k, filename in enumerate(filenames):
        ...
        # depth = depth_anything.infer_image(raw_image, args.input_size) # args.input_size = 518 = 14*37
        depth = depth_anything.infer_image_padder(raw_image) # args.input_size = 518 = 14*37
